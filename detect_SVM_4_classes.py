...
# download pre-trained model_gender file (one-time download)
model_age_path = "models/age_svm_0.718_4" 
...
def showWebcam(webcam):
    ...
    for idx, f in enumerate(face):
        ...
        cv2.putText(frame, "SVM (4 classes):" + svc_predict_age(tra_face_crop), (startX, Y),  cv2.FONT_HERSHEY_SIMPLEX,
                    0.7, (0, 255, 0), 2)
    return frame