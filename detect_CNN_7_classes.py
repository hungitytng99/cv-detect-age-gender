...
# download pre-trained model_gender file (one-time download)
model_age_path = "models/age_CNN_0.71_7.h5" 
...
age_classes=['1-2', '3-9', '10-20', '21-27', '28-45', '46-65', '66-116']
...
def showWebcam(webcam):
    ...
    for idx, f in enumerate(face):
        ...
        cv2.putText(frame, "CNN (7 classes):" + predict_age(img_age_array), (startX, Y),  cv2.FONT_HERSHEY_SIMPLEX,
                    0.7, (0, 255, 0), 2)
    return frame